...
# Instructions:
# You have one feature. You objective is to transform it into a matrix for a polynomial regression  of degree 6.
# In the matrix, the first column is the feature, the second : the feature power 2, ... until power 6.
# You can find an example of the desired matrix in the document Ex_5_poly_matrix_V11.txt

    feature = [-66, -605, 9, 139, 481, -58, -660, 282, 496, -712, -853, 283, 201, 86, -194, 423, -519, 456, 128, -326, -105, -130, 176, 417, 411, -40, -942, -272, 420, -506]
    feature = np.array(feature).reshape(-1, 1)

    poly6 = skprepro.PolynomialFeatures(6, include_bias = False)
    x_polymial = poly6.fit_transform(feature)
